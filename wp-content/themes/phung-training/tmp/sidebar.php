	...
	<div class="sidebar-inner">
		<div class="widget-area">
			<div class="sidebar-widget widget_search clr">
				<form method="get" id="searchform" class="site-searchform" action="#" role="search">
			...
			<div class="sidebar-widget widget_wpex_social_widget clr">
				<span class="widget-title">Lets Get Social</span>
					...
					<div class="wpex-tabs-widget-inner clr">
						...
						<div id="wpex-widget-popular-tab"
							...
							<ul class="clr">
								...
								<li class="clr">
									<a href="#" title="MotoCross is Beautiful Video" class="clr">
										<span class="counter">2</span>
										<span class="title strong">MotoCross is Beautiful Video:</span> Vivamus eu dui eget turpis iaculis
										facilisis vitae id felis.&hellip;
									</a>
								</li>
								<li class="clr">
									<a href="#" title="Best Places To Buy Music" class="clr">
										<span class="counter">3</span>
										<span class="title strong">Best Places To Buy Music:</span> Nam ultrices purus quis aliquet
										vehicula. Phasellus vestibulum vehicula dolor,&hellip;
									</a>
								</li>
								<li class="clr">
									<a href="#" title="Cute Teddy Bear Laughing" class="clr">
										<span class="counter">4</span>
										<span class="title strong">Cute Teddy Bear Laughing:</span> Vivamus facilisis tristique cursus.
										Sed sit amet risus tortor. Aliquam&hellip;
									</a>
								</li>
								<li class="clr">
									<a href="#" title="Lose 50 Pounds With The Hamburger Diet" class="clr">
										<span class="counter">5</span>
										<span class="title strong">Lose 50 Pounds With The Hamburger Diet:</span> One of the attending
										harpooneers now advances with a long,&hellip;
									</a>
								</li>
							</ul>
						</div>
							...
							<ul class="clr">
								<li class="clr">
									<a href="#" title="Formula 1 Is Boring But The Cars Are Super Awesome" class="clr">
										<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/02/shutterstock_80791570-100x100.jpg" alt="Formula 1 Is Boring But The Cars Are Super Awesome" width="100" height="100" />
								...
								<li class="clr">
									<a href="#" title="Hiking Mount Everest" class="clr">
										<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/09/shutterstock_90586426-100x100.jpg" alt="Hiking Mount Everest" width="100" height="100" />
								...
								<li class="clr">
									<a href="#" title="Nascar Final Results 2015" class="clr">
										<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/09/shutterstock_124918517-100x100.jpg" alt="Nascar Final Results 2015" width="100" height="100" />
								...
								<li class="clr">
									<a href="#" title="Mount Fuji Japan" class="clr">
										<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/09/shutterstock_146675243-100x100.jpg" alt="Mount Fuji Japan" width="100" height="100" />
							...
							<ul class="clr">
								<li class="clr">
									<a href="#" title="Homepage" class="clr">
										<img src='http://localhost/wordpress-traning/wp-content/themes/phung-training/files/avatar/1c292955bf55ec6172964107fd325638.png' class="avatar avatar-100 photo" />
										<span class="title strong">AJ Clarke:</span> Aenean ut blandit lorem. Nullam ut ultrices nulla, non tristique&hellip;&hellip;
									</a>
								</li>
								<li class="clr">
									<a href="#" title="Homepage" class="clr">
										<img alt='' src='http://localhost/wordpress-traning/wp-content/themes/phung-training/files/avatar/403d47c8b227172b283afd4e3ef7d969.png' class='avatar avatar-100 photo' height='100' width='100' />
										<span class="title strong">Matt Tucker:</span> Donec placerat, sapien eget eleifend mattis, sem urna sodales augue,&hellip;&hellip;
									</a>
								</li>
								<li class="clr">
									<a href="#" title="Homepage" class="clr">
										<img alt='' src='http://localhost/wordpress-traning/wp-content/themes/phung-training/files/avatar/6ab62b50dc9bfc3386899088c45fec03.jpeg' class='avatar avatar-100 photo' height='100' width='100' />
										<span class="title strong">Kyla G.:</span> Vivamus non arcu elementum, sollicitudin sem in, gravida lacus. Duis&hellip;&hellip;
									</a></li>
								<li class="clr">
									<a href="#" title="Homepage" class="clr">
										<img alt='' src='http://localhost/wordpress-traning/wp-content/themes/phung-training/files/avatar/1c292955bf55ec6172964107fd325638.png' class='avatar avatar-100 photo' height='100' width='100' />
			...
			<div class="sidebar-widget widget_wpex_slider_widget clr">
				<span class="widget-title">Slider Widget</span>
				<div class="slider-widget owl-carousel clr">
					<div class="slider-widget-slide clr">
						<a href="#" title="Formula 1 Is Boring But The Cars Are Super Awesome" class="widget-recent-posts-thumbnail clr">
							<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/02/shutterstock_80791570-620x350.jpg" alt="Formula 1 Is Boring But The Cars Are Super Awesome" width="620" height="350" />
					...
					<div class="slider-widget-slide clr">
						<a href="#" title="Online Fashion Shopping Tips" class="widget-recent-posts-thumbnail clr">
							<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2013/12/shutterstock_147074498-620x350.jpg" alt="Online Fashion Shopping Tips" width="620" height="350" />
					...
					<div class="slider-widget-slide clr">
						<a href="#"
						   ...
						   class="widget-recent-posts-thumbnail clr"> <img
								src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/09/shutterstock_180775436-620x350.jpg"
						...
						<div class="entry-cat-tag cat-40-bg">
							<a href="#" title="Featured Slider">Featured Slider</a>
						</div>
					</div>
					<!-- .widget-slider-slide -->
					<div class="slider-widget-slide clr">
						<a href="#" title="New War Statistics Shared To The Public" class="widget-recent-posts-thumbnail clr">
							<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/09/shutterstock_136240700-620x350.jpg" alt="New War Statistics Shared To The Public" width="620" height="350" />
			...
			<div class="sidebar-widget widget_wpex_recent_posts_thumb_widget clr">
				<span class="widget-title">Latest In Health</span>
				<ul class="widget-recent-posts clr">
					<li class="clr widget-recent-posts-li left-thumbnail format-">
						<a href="#" title="Don&#8217;t Forget To Stretch After Your Workout" class="widget-recent-posts-thumbnail clr">
							<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/09/shutterstock_73219318-620x350.jpg" alt="Don&#8217;t Forget To Stretch After Your Workout" width="620" height="350" />
						</a>
					...
					<li class="clr widget-recent-posts-li left-thumbnail format-">
						<a href="#" title="20 Healthy Sandwich Recipes" class="widget-recent-posts-thumbnail clr">
							<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/09/shutterstock_167586029-620x350.jpg" alt="20 Healthy Sandwich Recipes" width="620" height="350" />
						</a>
						<div class="widget-recent-posts-content clr">
					...
					<li class="clr widget-recent-posts-li left-thumbnail format-video">
						<a href="#" title="Bikini Booty Routine" class="widget-recent-posts-thumbnail clr">
							<img src="http://localhost/wordpress-traning/wp-content/themes/phung-training/files/uploads/2014/09/shutterstock_167044349-620x350.jpg" alt="Bikini Booty Routine" width="620" height="350" />
						</a>
						<div class="widget-recent-posts-content clr">
